...
namespace WindowsFormsApp1
{
    public partial class DataTransaksi : Form
    {
        ...
        private void BindData()
        {
            ...
            MySqlCommand read = new MySqlCommand("select * from datatransaksi where tanggal = '"+ dateTimePicker1.Value.ToString("yyyy-MM-dd") + "'", conn);
            conn.Open();
        ...
        public void SearchData(string search)
        {
            ...
            conn.Open();
            string query = "select * from datatransaksi where karyawan like '%" + find.Text + "%' AND tanggal like '%" + dateTimePicker1.Value.ToString("yyyy-MM-dd") + "%'";
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            ExportToPDFLaporanTransaksi(dtbl, "Laporan Transaksi Harian");
        }

        void ExportToPDFLaporanTransaksi(DataTable dtbl, string strHeader)
        {

            var saveFileDialoge = new SaveFileDialog();
            saveFileDialoge.FileName = "Laporan Transaksi Harian";
            ...
            if (saveFileDialoge.ShowDialog() == DialogResult.OK)
            {
                ...
                prgAuthor.Add(new Chunk("\nKeterangan : Laporan Transaksi Keuangan Harian", fntAuthor));
                doc.Add(prgAuthor);
                ...
                celltotal.AddElement(new Paragraph("Total"));
                celltotal.AddElement(new Paragraph("'"+ textBox1.Text +"'"));
                ...
                Desc.Add(new Chunk("Dibawah merupakan laporan keuangan harian pada tanggal '"+ DateTime.Now.ToShortDateString() +"' dan rincian tabel transaksi dibawah ini, untuk dapat mengontrol laporan keuangan harian diharapkan agar management dan kepala toko untuk menandatangani serah terima laporan." , fntAuthor));
                doc.Add(Desc);
                ...
                Desc2.Add(new Chunk("Demikian surat laporan keuangan hari ini dicetak.", fntAuthor));
                doc.Add(Desc2);
